...
import com.dango.pay.domain.entity.OrdersGoods;
import com.dango.pay.domain.entity.PayRecord;
import com.dango.pay.mapper.OrdersGoodsMapper;
import com.dango.pay.mapper.OrdersMapper;
...
/**
 * @author dango
 * @description 针对表【_orders】的数据库操作Service实现
...
//创建商品订单
        ...
        if (orders.getStatus().equals(PayStatus.PAID.getCode())) {
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto) {
        ...
        if (trade_status.equals("TRADE_SUCCESS")) {
            ...
            payRecord_u.setStatus(PayStatus.PAID.getCode());//支付成功
            ...
            order_u.setStatus(PayStatus.PAID.getCode());//支付成功
    ...
    @Transactional
    public Orders saveOrders(Long userId, AddOrderDto addOrderDto) {
        //幂等性处理
        ...
        order.setStatus(PayStatus.UNPAID.getCode());//未支付
        order.setUserId(userId);
        order.setOrderType(addOrderDto.getOrderType());
        order.setOrderName(addOrderDto.getOrderName());
        order.setOrderCourseId(addOrderDto.getOrderCourseId());
    ...
    public PayRecord createPayRecord(Orders orders) {
        ...
        payRecord.setStatus(PayStatus.UNPAID.getCode());//未支付
