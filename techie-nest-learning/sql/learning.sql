...
INSERT INTO `choose_course` (`id`, `course_id`, `course_name`, `user_id`, `company_id`, `order_type`, `create_date`,
                             `course_price`, `valid_days`, `status`, `valid_time_start`, `valid_time_end`, `remarks`)
...
INSERT INTO `course_tables` (`id`, `choose_course_id`, `user_id`, `course_id`, `company_id`, `course_name`,
                             `course_type`, `create_date`, `valid_time_start`, `valid_time_end`, `update_date`,
                             `remarks`)
...
/*!40000 ALTER TABLE `learn_record`
    DISABLE KEYS */;
INSERT INTO `learn_record` (`id`, `course_id`, `course_name`, `user_id`, `learn_date`, `learn_length`, `teach_plan_id`,
                            `teach_plan_name`)
