...
CREATE TABLE `course_tables` (
                                    ...
                                    `create_date` datetime NOT NULL COMMENT '添加时间',
                                    `valid_time_start` datetime DEFAULT NULL COMMENT '开始服务时间',
...
INSERT INTO `course_tables` (`id`, `choose_course_id`, `user_id`, `course_id`, `company_id`, `course_name`, `course_type`, `create_date`, `valid_time_start`, `valid_time_end`, `update_date`, `remarks`) VALUES (11,16,'52',121,1232141425,'Spring Cloud 开发实战','700002','2023-02-09 11:44:48','2023-02-09 11:43:32','2024-02-09 11:43:32',NULL,NULL);
...
CREATE TABLE `learn_record` (
                                   ...
                                   `teach_plan_id` bigint DEFAULT NULL COMMENT '章节id',
                                   `teach_plan_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '章节名称',
                                   PRIMARY KEY (`id`) USING BTREE,
                                   UNIQUE KEY `learn_record_unique` (`course_id`,`user_id`,`teach_plan_id`) USING BTREE
