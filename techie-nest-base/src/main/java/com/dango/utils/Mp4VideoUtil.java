...
//        Process p = builder.start();
        ...
        String ffmpeg_path = "ffmpeg";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "/Users/dango/Movies/sora/generator.mov";
        //转换后mp4文件的名称
        String mp4_name = "generator.mp4";
        //转换后mp4文件的路径
        String mp4_path = "/Users/dango/Movies/sora/generator.mp4";
        //创建工具类对象
